...
function resolveJoinModelClassIfDefined(ctx) {
  ...
  console.log('resolveJoinModelClassIfDefined', ctx.mapping.join.through.modelClass);
...
function createJoinProperties(ctx) {
  ...
  let relatedProp;
  let ownerProp;
  console.log('createJoinProperties');
...
function createRelationProperty(ctx, refString, messagePrefix) {
  ...
  const resolveModelClass = table => {
    console.log('createRelationProperty', joinTableModelClass, table)
    if (joinTableModelClass === null) {
      joinTableModelClass = inheritModel(getModel());
      console.log('on if', joinTableModelClass)
    ...
    console.log('joinTableModelClass', joinTableModelClass.getTableName(), table)
