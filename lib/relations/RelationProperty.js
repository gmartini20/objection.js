...
class RelationProperty {
  ...
  constructor(references, modelClassResolver) {
    ...
    console.log('RelationProperty', paths, modelClass.getTableName());
    ...
    console.log('this ---- RelationProperty', this._refs, this._props, this._cols, this._propGetters, this._propSetters);
  }
...
function createPaths(refs, modelClassResolver) {
  return refs.map(ref => {
    ...
    console.log('createPaths', jsonPath, prop);
    return {
